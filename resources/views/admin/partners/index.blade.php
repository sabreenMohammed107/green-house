...
<div class="box">
    <div class="box-header">
      <h3 class="box-title">شركاء النجاح</h3>
      <a href="{{ route('admin-partners.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
                ...
                data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
						...
						@foreach($rows as $index => $row)
							<tr>
                                <td></td>
                                <td>{{ $index + 1 }}</td>
                                <td> <img style="width:100px" src="{{ asset('uploads/partners') }}/{{ $row->logo ?? '' }}">
                                </td>
                                <td>{{$row->name}}</td>
                                ...
                                <td>{!! $row->description !!} </td>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin-partners.edit', $row->id) }}">
