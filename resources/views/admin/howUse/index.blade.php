...
<div class="box">
    <div class="box-header">
      ...
      <a href="{{ route('admin-how-use.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
						...
						@foreach($rows as $index => $row)
							<tr>
                                ...
                                <td>{!! $row->text !!} </td>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin-how-use.edit', $row->id) }}">
                             ...
                             <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                ...
                                <form action="{{ route('admin-how-use.destroy', $row->id) }}"  method="POST" >
                                    @csrf
                                    @method('DELETE')
