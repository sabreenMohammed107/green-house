              ...
              @csrf
                  ...
                  <div class="box-body">
                        ...
                        <div class="form-group">
                            <label  >{{ __('  النص  ') }}</label>
                                <input type="text" id="newTitle" name="counter_text" value="{{$row->counter_text}}" class="form-control"
                                   placeholder=" النص">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control " name="counter_value">{{$row->counter_value}}</textarea>
