...
<div class="box">
    <div class="box-header">
      <h3 class="box-title">جرين هاوس بالارقام </h3>
      {{-- <a href="{{ route('admin-counter.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a> --}}
                ...
                data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
						...
						@foreach($rows as $index => $row)
							<tr>
                                <td></td>
                                <td>{{ $index + 1 }}</td>
                                <td>{{$row->counter_text	}}</td>

                                <td>{!! $row->counter_value !!} </td>
                                ...
                                <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin-counter.edit', $row->id) }}">
                             ...
                             <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                ...
                                <form action="{{ route('admin-counter.destroy', $row->id) }}"  method="POST" >
                                    @csrf
                                    @method('DELETE')
