                                        ...
                                        <td>
                                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                                ...
                                                <a class="btn btn-success" title="edit"
                                                 ...
                                                 <form id="form-id" action="{{ route('my-items.destroy', $item->id) }}" style="display: none"  method="POST" >
                                                    @csrf
                                                    @method('DELETE')

                                                 </form>
                                                 <button type="button" class="btn btn-success" onclick="document.getElementById('form-id').submit();" title="delete"><i class="fa-solid fa-trash"></i></button>
